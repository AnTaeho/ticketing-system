package com.example.ticketing.reservation.service.v1;
...
public class TicketServiceV1 implements TicketService {
    ...
    private void decreaseStock(Concert concert) {
        concert.decrease();
        log.info("[V1] 재고 차감 - concertId={}, 차감 후 재고={}", concert.getId(), concert.getStock());
    }
    ...
    private Reservation saveReservation(Long concertId, Long userId) {
        ...
        log.info("[V1] 예약 완료 - reservationId={}, userId={}", reservation.getId(), userId);
        return reservation;
    }
}
